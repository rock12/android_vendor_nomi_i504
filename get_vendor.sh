...
#
GL="/lib/egl/libGLESv1_CM_mali.so 
/lib/egl/libGLESv2_mali.so 
/lib/egl/libEGL_mali.so
/lib/libm4u.so 
/lib/hw/hwcomposer.mt6580.so 
/lib/hw/gralloc.mt6580.so 
...
/lib/hw/audio.primary.mt6580.so
/lib/libmtkplayer.so 
/lib/libvcodecdrv.so 
